...
static vtss_rc lu26_misc_irq_cfg(struct vtss_state_s *vtss_state,
...
static vtss_rc lu26_misc_irq_status(struct vtss_state_s *vtss_state,
...
static vtss_rc lu26_misc_irq_enable(struct vtss_state_s *vtss_state,
                                   const vtss_irq_t irq,
                                   const BOOL enable)
{
    u32 mask;
