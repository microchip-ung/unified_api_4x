#ifndef _VTSS_JAGUAR_REGS_DEVCPU_QS_H_
#define _VTSS_JAGUAR_REGS_DEVCPU_QS_H_
 ...
 *
 * @param ri Replicator: x_DEVCPU_QS_NUM_XTR_QUEUES (??), 0-9
 */
 ...
 *
 * @param ri Replicator: x_DEVCPU_QS_NUM_XTR_GROUPS (??), 0-3
 */
#define VTSS_DEVCPU_QS_XTR_XTR_GRP_CFG(ri)   VTSS_IOREG(VTSS_TO_DEVCPU_QS,0xa + (ri))
 ...
 * @param ri Replicator: x_DEVCPU_QS_NUM_XTR_QUEUES (??), 0-9
 */
#define VTSS_DEVCPU_QS_XTR_XTR_MAP(ri)       VTSS_IOREG(VTSS_TO_DEVCPU_QS,0xe + (ri))
 ...
 */
#define  VTSS_F_DEVCPU_QS_XTR_XTR_MAP_GRP(x)  VTSS_ENCODE_BITFIELD(x,4,2)
#define  VTSS_M_DEVCPU_QS_XTR_XTR_MAP_GRP     VTSS_ENCODE_BITMASK(4,2)
#define  VTSS_X_DEVCPU_QS_XTR_XTR_MAP_GRP(x)  VTSS_EXTRACT_BITFIELD(x,4,2)
 ...
 *
 * @param ri Replicator: x_DEVCPU_QS_NUM_XTR_GROUPS_MUL_PCI_BURST_SIZE (??), 0-3
 */
#define VTSS_DEVCPU_QS_XTR_XTR_RD(ri)        VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x18 + (ri))
 ...
 * @param ri Replicator: x_DEVCPU_QS_NUM_XTR_GROUPS (??), 0-3
 */
#define VTSS_DEVCPU_QS_XTR_XTR_QU_SEL(ri)    VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x1c + (ri))

/** 
 * \brief
 * Scheduling of queues within a queue group.
 * Scheduling of the individual queues within a group can be done either in
 * a work-conserving round-robin or strict priority fashion. If using
 * strict priority scheduling the highest queue has the highest priority.
 *
 * \details 
 * '00': Scheduling is work-conserving round robin.
 * '01': Scheduling is strict priority.
 *
 * Field: ::VTSS_DEVCPU_QS_XTR_XTR_QU_SEL . QU_SCH
 */
#define  VTSS_F_DEVCPU_QS_XTR_XTR_QU_SEL_QU_SCH(x)  VTSS_ENCODE_BITFIELD(x,0,2)
#define  VTSS_M_DEVCPU_QS_XTR_XTR_QU_SEL_QU_SCH     VTSS_ENCODE_BITMASK(0,2)
#define  VTSS_X_DEVCPU_QS_XTR_XTR_QU_SEL_QU_SCH(x)  VTSS_EXTRACT_BITFIELD(x,0,2)
 ...
 */
#define VTSS_DEVCPU_QS_XTR_XTR_QU_FLUSH      VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x20)
 ...
 */
#define  VTSS_F_DEVCPU_QS_XTR_XTR_QU_FLUSH_FLUSH(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_DEVCPU_QS_XTR_XTR_QU_FLUSH_FLUSH     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_DEVCPU_QS_XTR_XTR_QU_FLUSH_FLUSH(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 */
#define VTSS_DEVCPU_QS_XTR_XTR_DATA_PRESENT  VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x21)
 ...
 */
#define  VTSS_F_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT(x)  VTSS_ENCODE_BITFIELD(x,4,10)
#define  VTSS_M_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT     VTSS_ENCODE_BITMASK(4,10)
#define  VTSS_X_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT(x)  VTSS_EXTRACT_BITFIELD(x,4,10)
 ...
 */
#define  VTSS_F_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT_GRP(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT_GRP     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_DEVCPU_QS_XTR_XTR_DATA_PRESENT_DATA_PRESENT_GRP(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define VTSS_DEVCPU_QS_XTR_XTR_QU_DBG        VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x22)
 ...
 *
 * @param ri Replicator: x_DEVCPU_QS_NUM_INJ_GROUPS (??), 0-4
 */
#define VTSS_DEVCPU_QS_INJ_INJ_GRP_CFG(ri)   VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x23 + (ri))
 ...
 *
 * @param ri Replicator: x_DEVCPU_QS_NUM_INJ_GROUPS_MUL_PCI_BURST_SIZE (??), 0-4
 */
#define VTSS_DEVCPU_QS_INJ_INJ_WR(ri)        VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x28 + (ri))
 ...
 * @param ri Replicator: x_DEVCPU_QS_NUM_INJ_GROUPS (??), 0-4
 */
#define VTSS_DEVCPU_QS_INJ_INJ_CTRL(ri)      VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x2d + (ri))
 ...
 */
#define VTSS_DEVCPU_QS_INJ_INJ_STATUS        VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x32)
 ...
 */
#define  VTSS_F_DEVCPU_QS_INJ_INJ_STATUS_WMARK_REACHED(x)  VTSS_ENCODE_BITFIELD(x,10,5)
#define  VTSS_M_DEVCPU_QS_INJ_INJ_STATUS_WMARK_REACHED     VTSS_ENCODE_BITMASK(10,5)
#define  VTSS_X_DEVCPU_QS_INJ_INJ_STATUS_WMARK_REACHED(x)  VTSS_EXTRACT_BITFIELD(x,10,5)
 ...
 */
#define  VTSS_F_DEVCPU_QS_INJ_INJ_STATUS_FIFO_RDY(x)  VTSS_ENCODE_BITFIELD(x,5,5)
#define  VTSS_M_DEVCPU_QS_INJ_INJ_STATUS_FIFO_RDY     VTSS_ENCODE_BITMASK(5,5)
#define  VTSS_X_DEVCPU_QS_INJ_INJ_STATUS_FIFO_RDY(x)  VTSS_EXTRACT_BITFIELD(x,5,5)
 ...
 */
#define  VTSS_F_DEVCPU_QS_INJ_INJ_STATUS_INJ_IN_PROGRESS(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_QS_INJ_INJ_STATUS_INJ_IN_PROGRESS     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_QS_INJ_INJ_STATUS_INJ_IN_PROGRESS(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 * @param ri Replicator: x_DEVCPU_QS_NUM_INJ_GROUPS (??), 0-4
 */
#define VTSS_DEVCPU_QS_INJ_INJ_ERR(ri)       VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x33 + (ri))
...
#endif /* _VTSS_JAGUAR_REGS_DEVCPU_QS_H_ */
