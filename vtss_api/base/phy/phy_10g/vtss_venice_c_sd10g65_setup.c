...
if(res_struct->chip_needs_hrate_toggle[0] == 1) {
    ...
    value &= VTSS_F_VENICE_DEV1_32_SD10G65_TX_RCPLL_SD10G65_TX_RCPLL_STAT0_PLLF_LOCK_STAT;
    value = (value > 0) ? 1 : 0;
    if(value != 0x1) {
    ...
    value = VTSS_X_VENICE_DEV1_32_SD10G65_TX_RCPLL_SD10G65_TX_RCPLL_STAT1_PLLF_FSM_STAT(value);
    if(value != 0xd) {
...
if(res_struct->chip_needs_hrate_toggle[0] == 1) {
    ...
    value &= VTSS_F_VENICE_DEV1_32_SD10G65_RX_RCPLL_SD10G65_RX_RCPLL_STAT0_PLLF_LOCK_STAT;
    value = (value > 0) ? 1 : 0;
    if(value != 0x1) {
    ...
    value = VTSS_X_VENICE_DEV1_32_SD10G65_RX_RCPLL_SD10G65_RX_RCPLL_STAT1_PLLF_FSM_STAT(value);
    if(value != 0xd) {
...
if( res_struct->incl_ld_cal[0] == 1 ) {
    ...
    value &= VTSS_F_VENICE_DEV1_32_SD10G65_APC_APC_LD_CAL_CFG_DETLEV_CAL_DONE;
    value = (value > 0) ? 1 : 0;
    if(value != 0x1) {
    ...
    value &= VTSS_F_VENICE_DEV1_32_SD10G65_APC_APC_IS_CAL_CFG1_OFFSCAL_DONE;
    value = (value > 0) ? 1 : 0;
    if(value != 0x1) {
