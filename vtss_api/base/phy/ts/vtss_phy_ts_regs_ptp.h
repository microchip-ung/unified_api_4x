...
/**
 * \brief 1588 block revision info register
 *
 * \details
 * Register: \a PTP:IP_1588_TOP_CFG_STAT:VERSION_CODE
 *
 * @param target A \a ::vtss_target_PTP_e target
 */
#define VTSS_PTP_IP_1588_TOP_CFG_STAT_VERSION_CODE  VTSS_IOREG(0x3)
