                                                   ...
                                                   const vtss_macsec_default_action_policy_t *const pattern)
{
    ...
    CSR_WARM_WRM(port_no, VTSS_MACSEC_INGR_FRAME_MATCHING_HANDLING_CTRL_SAM_NM_FLOW_NCP,
    ...
    CSR_WARM_WRM(port_no, VTSS_MACSEC_INGR_FRAME_MATCHING_HANDLING_CTRL_SAM_NM_FLOW_CP,
    ...
    CSR_WARM_WRM(port_no, VTSS_MACSEC_EGR_FRAME_MATCHING_HANDLING_CTRL_SAM_NM_FLOW_NCP,
    ...
    CSR_WARM_WRM(port_no, VTSS_MACSEC_EGR_FRAME_MATCHING_HANDLING_CTRL_SAM_NM_FLOW_CP,
...

{
    ...
    printf("\n\tif_rx_puase                : %d", counters->if_rx_pause_pkts);
