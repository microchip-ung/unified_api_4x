...
typedef enum {
    ...
    AQR_PHY_FAMILY_HHD        /* 1/2/4-port package, 28nm architechture */
#endif
} vtss_phy_family_t;
...
#if defined(AQR_CHIP_CU_PHY)
vtss_rc aqr_phy_veriphy_task_start(struct vtss_state_s *vtss_state, vtss_port_no_t port_no);
#endif
...
////#if (VTSS_FEATURE_SERDES_MACRO_SETTINGS) && (TESLA_ING_TS_ERRFIX)
/* ********************************************************************* */
/*            The following Definitions Apply for Tesle SERDES ONLY      */
/* ********************************************************************* */
...
typedef enum {
    ...
    VTSS_PHY_SERDES_INIT_MAC_MEDIA      /* Both MAC & MEDIA */
...
// SERDES1G_DIG_CFG
#define VTSS_TESLA_SERDES1G_DIG_CFG_LANE_RST_1G             (VTSS_TESLA_SD1G_ANA_CFG_SIZE+0)  // cfg_vec[0+100]
#define VTSS_TESLA_SERDES1G_DIG_CFG_DES_100FX_CPMD_ENA_1G   (VTSS_TESLA_SD1G_ANA_CFG_SIZE+5)  // cfg_vec[5+100]
#define VTSS_TESLA_SERDES1G_DIG_CFG_DES_100FX_CPMD_MODE_1G  (VTSS_TESLA_SD1G_ANA_CFG_SIZE+6)  // cfg_vec[6+100]
// SERDES6G_ANA_CFG
...
// SERDES6G_DIG_CFG
#define VTSS_TESLA_SERDES6G_DIG_CFG_LANE_RST_6G     (VTSS_TESLA_SD6G_ANA_CFG_SIZE+25) // cfg_vec[25+148]
// RCOMP_CFG
...
////#endif (VTSS_FEATURE_SERDES_MACRO_SETTINGS) && (TESLA_ING_TS_ERRFIX)
