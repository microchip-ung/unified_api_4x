#ifndef _VTSS_SEVILLE_REGS_ANA_H_
#define _VTSS_SEVILLE_REGS_ANA_H_
 ...
 */
#define VTSS_ANA_ANA_ADVLEARN                VTSS_IOREG(VTSS_TO_ANA,0x2d40)
 ...
 */
#define  VTSS_F_ANA_ANA_ADVLEARN_VLAN_CHK     VTSS_BIT(10)
 ...
 */
#define  VTSS_F_ANA_ANA_ADVLEARN_LEARN_MIRROR(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_ANA_ANA_ADVLEARN_LEARN_MIRROR     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_ANA_ANA_ADVLEARN_LEARN_MIRROR(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 */
#define VTSS_ANA_ANA_VLANMASK                VTSS_IOREG(VTSS_TO_ANA,0x2d41)
 ...
 */
#define  VTSS_F_ANA_ANA_VLANMASK_VLANMASK(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_VLANMASK_VLANMASK     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_VLANMASK_VLANMASK(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_ANAGEFIL                VTSS_IOREG(VTSS_TO_ANA,0x2d43)
 ...
 */
#define VTSS_ANA_ANA_ANEVENTS                VTSS_IOREG(VTSS_TO_ANA,0x2d44)
 ...
 */
#define VTSS_ANA_ANA_STORMLIMIT_BURST        VTSS_IOREG(VTSS_TO_ANA,0x2d45)
 ...
 */
#define VTSS_ANA_ANA_STORMLIMIT_CFG(ri)      VTSS_IOREG(VTSS_TO_ANA,0x2d46 + (ri))
 ...
 */
#define VTSS_ANA_ANA_ISOLATED_PORTS          VTSS_IOREG(VTSS_TO_ANA,0x2d4a)
 ...
 */
#define  VTSS_F_ANA_ANA_ISOLATED_PORTS_ISOL_PORTS(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_ISOLATED_PORTS_ISOL_PORTS     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_ISOLATED_PORTS_ISOL_PORTS(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_COMMUNITY_PORTS         VTSS_IOREG(VTSS_TO_ANA,0x2d4b)
 ...
 */
#define  VTSS_F_ANA_ANA_COMMUNITY_PORTS_COMM_PORTS(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_COMMUNITY_PORTS_COMM_PORTS     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_COMMUNITY_PORTS_COMM_PORTS(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_AUTOAGE                 VTSS_IOREG(VTSS_TO_ANA,0x2d4c)
 ...
 */
#define VTSS_ANA_ANA_MACTOPTIONS             VTSS_IOREG(VTSS_TO_ANA,0x2d4d)
 ...
 */
#define VTSS_ANA_ANA_LEARNDISC               VTSS_IOREG(VTSS_TO_ANA,0x2d4e)
 ...
 */
#define VTSS_ANA_ANA_AGENCTRL                VTSS_IOREG(VTSS_TO_ANA,0x2d4f)
...
/** 
 * \brief
 * Flood frames using the lowest 11 bits of DMAC as destination port mask.
 ...
 */
#define VTSS_ANA_ANA_MIRRORPORTS             VTSS_IOREG(VTSS_TO_ANA,0x2d50)
 ...
 */
#define  VTSS_F_ANA_ANA_MIRRORPORTS_MIRRORPORTS(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_MIRRORPORTS_MIRRORPORTS     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_MIRRORPORTS_MIRRORPORTS(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_EMIRRORPORTS            VTSS_IOREG(VTSS_TO_ANA,0x2d51)
 ...
 */
#define  VTSS_F_ANA_ANA_EMIRRORPORTS_EMIRRORPORTS(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_EMIRRORPORTS_EMIRRORPORTS     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_EMIRRORPORTS_EMIRRORPORTS(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_FLOODING                VTSS_IOREG(VTSS_TO_ANA,0x2d52)
 ...
 */
#define VTSS_ANA_ANA_FLOODING_IPMC           VTSS_IOREG(VTSS_TO_ANA,0x2d53)
 ...
 */
#define VTSS_ANA_ANA_SFLOW_CFG(ri)           VTSS_IOREG(VTSS_TO_ANA,0x2d54 + (ri))
 ...
 */
#define VTSS_ANA_ANA_PORT_MODE(ri)           VTSS_IOREG(VTSS_TO_ANA,0x2d5f + (ri))
 ...
 * There are 64 destination masks in total. By default, the first 10 port
 ...
 *
 * @param ri Replicator: x_NUM_PGIDS (??), 0-90
 */
#define VTSS_ANA_PGID_PGID(ri)               VTSS_IOREG(VTSS_TO_ANA,0x2d80 + (ri))
 ...
 */
#define  VTSS_F_ANA_PGID_PGID_PGID(x)         VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_PGID_PGID_PGID            VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_PGID_PGID_PGID(x)         VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_TABLES_ANMOVED          VTSS_IOREG(VTSS_TO_ANA,0x2d2b)
 ...
 */
#define  VTSS_F_ANA_ANA_TABLES_ANMOVED_ANMOVED(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_ANA_TABLES_ANMOVED_ANMOVED     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_ANA_TABLES_ANMOVED_ANMOVED(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_ANA_TABLES_MACHDATA         VTSS_IOREG(VTSS_TO_ANA,0x2d2c)
 ...
 */
#define VTSS_ANA_ANA_TABLES_MACLDATA         VTSS_IOREG(VTSS_TO_ANA,0x2d2d)
 ...
 */
#define VTSS_ANA_ANA_TABLES_MACACCESS        VTSS_IOREG(VTSS_TO_ANA,0x2d2e)
 ...
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_TABLES_MACACCESS . RESERVED
 */
#define  VTSS_F_ANA_ANA_TABLES_MACACCESS_RESERVED  VTSS_BIT(18)
 ...
 */
#define VTSS_ANA_ANA_TABLES_MACTINDX         VTSS_IOREG(VTSS_TO_ANA,0x2d2f)
 ...
 */
#define VTSS_ANA_ANA_TABLES_VLANACCESS       VTSS_IOREG(VTSS_TO_ANA,0x2d30)
 ...
 */
#define  VTSS_F_ANA_ANA_TABLES_VLANACCESS_VLAN_PORT_MASK(x)  VTSS_ENCODE_BITFIELD(x,2,11)
#define  VTSS_M_ANA_ANA_TABLES_VLANACCESS_VLAN_PORT_MASK     VTSS_ENCODE_BITMASK(2,11)
#define  VTSS_X_ANA_ANA_TABLES_VLANACCESS_VLAN_PORT_MASK(x)  VTSS_EXTRACT_BITFIELD(x,2,11)
 ...
 */
#define VTSS_ANA_ANA_TABLES_VLANTIDX         VTSS_IOREG(VTSS_TO_ANA,0x2d31)
 ...
 * @param ri Replicator: x_SPORT_CNT (??), 0-10
 */
#define VTSS_ANA_ANA_TABLES_ENTRYLIM(ri)     VTSS_IOREG(VTSS_TO_ANA,0x2d20 + (ri))
 ...
 *
 * Classifier configuration per switch port
 */
 ...
 *
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_VLAN_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,0)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_DROP_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,1)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_QOS_CFG(gi)            VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,2)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_VCAP_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,3)
 ...
 */
#define VTSS_ANA_PORT_VCAP_S1_KEY_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,ri,4)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_VCAP_S2_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,7)
 ...
 */
#define VTSS_ANA_PORT_QOS_PCP_DEI_MAP_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,ri,8)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_CPU_FWD_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,24)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_CPU_FWD_BPDU_CFG(gi)   VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,25)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_CPU_FWD_GARP_CFG(gi)   VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,26)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_CPU_FWD_CCM_CFG(gi)    VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,27)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_PORT_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,28)
 ...
 * @param gi Register: PORT (??), 0-10
 */
#define VTSS_ANA_PORT_POL_CFG(gi)            VTSS_IOREG_IX(VTSS_TO_ANA,0x0,gi,64,0,29)

/** 
 * \brief
 * Enable port policing for frames on received on this port. Port policing
 * on physical port P uses policer P.
 *
 * \details 
...
/** 
 * \brief
 * Each frame is checked against three policers: 1) port, 2) QoS, and 3)
 * VCAP. In this register, a bit set makes updating of a policer dependant
 ...
 * Bit5: VCAP policer must be open in order to update QoS policer with
 * frame
 * 
 * Bit6: Port policer must be open in order to update VCAP policer with
 * frame
 * Bit7: QoS policer must be open in order to update VCAP policer with
 * frame
 ...
 *
 * Priority-based flow control configuration per front port
 */
 ...
 *
 * @param gi Replicator: x_FPORT_CNT (??), 0-9
 */
#define VTSS_ANA_PFC_PFC_CFG(gi)             VTSS_IOREG_IX(VTSS_TO_ANA,0x3000,gi,16,0,0)
 ...
 */
#define VTSS_ANA_COMMON_AGGR_CFG             VTSS_IOREG(VTSS_TO_ANA,0x3180)
 ...
 */
#define VTSS_ANA_COMMON_CPUQ_CFG             VTSS_IOREG(VTSS_TO_ANA,0x3181)
 ...
 */
#define VTSS_ANA_COMMON_CPUQ_8021_CFG(ri)    VTSS_IOREG(VTSS_TO_ANA,0x3183 + (ri))
 ...
 */
#define VTSS_ANA_COMMON_DSCP_CFG(ri)         VTSS_IOREG(VTSS_TO_ANA,0x3193 + (ri))
 ...
 */
#define VTSS_ANA_COMMON_DSCP_REWR_CFG(ri)    VTSS_IOREG(VTSS_TO_ANA,0x31d3 + (ri))
 ...
 */
#define VTSS_ANA_COMMON_VCAP_RNG_TYPE_CFG(ri)  VTSS_IOREG(VTSS_TO_ANA,0x31e3 + (ri))
 ...
 */
#define VTSS_ANA_COMMON_VCAP_RNG_VAL_CFG(ri)  VTSS_IOREG(VTSS_TO_ANA,0x31eb + (ri))
 ...
 */
#define VTSS_ANA_COMMON_DISCARD_CFG          VTSS_IOREG(VTSS_TO_ANA,0x31f6)
 ...
 */
#define VTSS_ANA_COMMON_FID_CFG              VTSS_IOREG(VTSS_TO_ANA,0x31f7)
 ...
 *
 * Policer configuration per policer
 */
 ...
 *
 * @param gi Replicator: x_POL_CNT (??), 0-162
 */
#define VTSS_ANA_POL_POL_PIR_CFG(gi)         VTSS_IOREG_IX(VTSS_TO_ANA,0x2800,gi,8,0,0)
 ...
 * @param gi Replicator: x_POL_CNT (??), 0-162
 */
#define VTSS_ANA_POL_POL_CIR_CFG(gi)         VTSS_IOREG_IX(VTSS_TO_ANA,0x2800,gi,8,0,1)

/** 
 * \brief
 * Comitted information rate (CIR). Unit is 33 1/3 kbps.
 *
 * \details 
 ...
 * @param gi Replicator: x_POL_CNT (??), 0-162
 */
#define VTSS_ANA_POL_POL_MODE_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_ANA,0x2800,gi,8,0,2)
 ...
 * @param gi Replicator: x_POL_CNT (??), 0-162
 */
#define VTSS_ANA_POL_POL_PIR_STATE(gi)       VTSS_IOREG_IX(VTSS_TO_ANA,0x2800,gi,8,0,3)
 ...
 * @param gi Replicator: x_POL_CNT (??), 0-162
 */
#define VTSS_ANA_POL_POL_CIR_STATE(gi)       VTSS_IOREG_IX(VTSS_TO_ANA,0x2800,gi,8,0,4)
 ...
 *
 * @param ri Register: POL_FLOWC (??), 0-9
 */
#define VTSS_ANA_POL_MISC_POL_FLOWC(ri)      VTSS_IOREG(VTSS_TO_ANA,0x30a0 + (ri))
 ...
 */
#define VTSS_ANA_POL_MISC_POL_HYST           VTSS_IOREG(VTSS_TO_ANA,0x30bb)
...
#endif /* _VTSS_SEVILLE_REGS_ANA_H_ */
