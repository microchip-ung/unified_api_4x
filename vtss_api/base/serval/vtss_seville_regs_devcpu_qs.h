...
/**
 * Register Group: \a DEVCPU_QS:REMAP
 *
 * Interrupt control and remap
 */
 ...
 *
 * \details
 * Register: \a DEVCPU_QS:REMAP:INTR_ENABLE
 */
#define VTSS_DEVCPU_QS_REMAP_INTR_ENABLE     VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x400)

/** 
 * \brief
 * Extration group interrupt enable
 *
 * \details 
 * NB: Grp2 = 0, Grp1 = 1
 *  0: Interrupt disabled, 1: enabled
 *
 * Field: ::VTSS_DEVCPU_QS_REMAP_INTR_ENABLE . XTR_GRP
 */
#define  VTSS_F_DEVCPU_QS_REMAP_INTR_ENABLE_XTR_GRP(x)  VTSS_ENCODE_BITFIELD(x,6,2)
#define  VTSS_M_DEVCPU_QS_REMAP_INTR_ENABLE_XTR_GRP     VTSS_ENCODE_BITMASK(6,2)
#define  VTSS_X_DEVCPU_QS_REMAP_INTR_ENABLE_XTR_GRP(x)  VTSS_EXTRACT_BITFIELD(x,6,2)
 ...
 *
 * \details
 * Register: \a DEVCPU_QS:REMAP:INTR_STICKY
 */
#define VTSS_DEVCPU_QS_REMAP_INTR_STICKY     VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x401)

/** 
 * \brief
 * Extration group interrupt sticky status (RW)
 * 
 *  This register contains sticky bits for each related seville signal.
 *  The bits are automatically set on rising edge of seville data_present
 *  signal.  They must be manually cleared, each bit is reset by writing 1
 *  to it.
 *
 * \details 
 * NB: Grp2 = 0, Grp1 = 1
 *  0: Interrupt inactive, 1: active
 *
 * Field: ::VTSS_DEVCPU_QS_REMAP_INTR_STICKY . XTR_GRP
 */
#define  VTSS_F_DEVCPU_QS_REMAP_INTR_STICKY_XTR_GRP(x)  VTSS_ENCODE_BITFIELD(x,6,2)
#define  VTSS_M_DEVCPU_QS_REMAP_INTR_STICKY_XTR_GRP     VTSS_ENCODE_BITMASK(6,2)
#define  VTSS_X_DEVCPU_QS_REMAP_INTR_STICKY_XTR_GRP(x)  VTSS_EXTRACT_BITFIELD(x,6,2)
 ...
 *
 * \details
 * Register: \a DEVCPU_QS:REMAP:INTR_RAW
 */
#define VTSS_DEVCPU_QS_REMAP_INTR_RAW        VTSS_IOREG(VTSS_TO_DEVCPU_QS,0x402)

/** 
 * \brief
 * Extration group interrupt status (RO)
 * 
 *  This register is read-only, can be used to read the data_present status
 *  from seville.
 *
 * \details 
 * NB: Grp2 = 0, Grp1 = 1
 *  0: Interrupt inactive, 1: active
 *
 * Field: ::VTSS_DEVCPU_QS_REMAP_INTR_RAW . XTR_GRP
 */
#define  VTSS_F_DEVCPU_QS_REMAP_INTR_RAW_XTR_GRP(x)  VTSS_ENCODE_BITFIELD(x,6,2)
#define  VTSS_M_DEVCPU_QS_REMAP_INTR_RAW_XTR_GRP     VTSS_ENCODE_BITMASK(6,2)
#define  VTSS_X_DEVCPU_QS_REMAP_INTR_RAW_XTR_GRP(x)  VTSS_EXTRACT_BITFIELD(x,6,2)
