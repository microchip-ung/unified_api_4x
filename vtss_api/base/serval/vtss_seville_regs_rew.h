#ifndef _VTSS_SEVILLE_REGS_REW_H_
#define _VTSS_SEVILLE_REGS_REW_H_
 ...
 *
 * @param gi Replicator: x_DPORT_CNT (??), 0-11
 */
 ...
 */
#define VTSS_REW_COMMON_DSCP_REMAP_DP1_CFG(ri)  VTSS_IOREG(VTSS_TO_REW,0x184 + (ri))
 ...
 */
#define VTSS_REW_COMMON_DSCP_REMAP_CFG(ri)   VTSS_IOREG(VTSS_TO_REW,0x1c4 + (ri))
...
#endif /* _VTSS_SEVILLE_REGS_REW_H_ */
