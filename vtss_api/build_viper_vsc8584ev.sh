...
gcc -g -o vtss_api_viper_vsc8584ev -I include -I boards -DVTSS_OPSYS_LINUX=1  -DVTSS_OPT_PORT_COUNT=4 -D_INCLUDE_DEBUG_TERM_PRINT_ -DVTSS_CHIP_CU_PHY -DVIPER_EVAL_BOARD -DVTSS_FEATURE_EEE -DVTSS_SW_OPTION_EEE -DVTSS_FEATURE_SERDES_MACRO_SETTINGS -DVTSS_FEATURE_PHY_TIMESTAMP -DVTSS_FEATURE_MACSEC appl/vtss_appl_board_viper_eval.c appl/vtss_appl_cu_phy.c base/ail/vtss_api.c  base/ail/vtss_common.c  base/phy/common/vtss_phy_common.c base/phy/ts/vtss_phy_ts_api.c base/phy/macsec/vtss_macsec_api.c `find base/phy/phy_1g -name "*.c"`
##
